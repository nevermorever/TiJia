...
public class ToBeEvaluatedFaultRecordFragment extends BaseFragment implements OnRefreshListener, OnLoadmoreListener, BaseQuickAdapter.OnItemClickListener, BaseQuickAdapter.OnItemChildClickListener {
    ...
    protected int getContentLayoutId() {
        return R.layout.fragment_to_be_evaluated_fault_record;
    }
    ...
    private class Adapter extends BaseQuickAdapter<FaultRecord, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, FaultRecord item) {
            ...
            helper.setText(R.id.tv_fault_type, faultType)
                    ...
                    .setText(R.id.fault_record_action_button, "评价")
                    ...
                    .addOnClickListener(R.id.fault_record_action_button);
        }
    }
