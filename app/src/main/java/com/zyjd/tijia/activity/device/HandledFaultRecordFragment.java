...
public class HandledFaultRecordFragment extends BaseFragment implements OnRefreshListener, OnLoadmoreListener, BaseQuickAdapter.OnItemClickListener {
    ...
    protected int getContentLayoutId() {
        return R.layout.fragment_unhandle_fault_record;
    }
    ...
    private class Adapter extends BaseQuickAdapter<FaultRecord, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, FaultRecord item) {
            ...
            helper.getView(R.id.rl_fault_record_action).setVisibility(View.GONE);
            switch (faultCode) {
                case "1":
                    faultType = "系统电源故障";
                    break;
